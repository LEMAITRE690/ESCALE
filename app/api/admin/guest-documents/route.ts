// GET /api/admin/guest-documents — liste les documents voyageur, réservé aux admins.
...
export async function GET(req: NextRequest) {
  ...
  let requete = supabaseAdmin
    ...
    .select("id, guest_id, document_type, status, uploaded_at, note_admin, profiles ( full_name, email )")
